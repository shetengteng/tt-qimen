    ...
    ai: {
      ...
      model: {
        ...
        refresh: {
          ...
          loading: 'Fetching the latest model list…',
          unsupported: 'This provider does not expose a remote model list',
          empty: 'This provider returned no usable models',
          error: 'Refresh failed: {message}',
          useHardcoded: 'Using built-in model list',
          useRemote: 'Using live model list',
          fromCache: '{count} models',
          clear: 'Clear cache',
          justNow: 'just now',
          minutesAgo: '{n} min ago',
          atTime: 'today at {time}',
        },
      },
      temperature: {
