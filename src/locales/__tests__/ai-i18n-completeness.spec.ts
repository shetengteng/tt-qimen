...
const ROOT_AI_PATHS: readonly string[] = [
  ...
  'ai.drawer.newChat',
  'ai.drawer.newChatAria',
  'ai.drawer.newChatTitle',
  'ai.drawer.newChatConfirm',
  'ai.drawer.newChatConfirmBtn',
  'ai.drawer.newChatCancel',
...
const SETTINGS_AI_PATHS: readonly string[] = [
  ...
  'section.ai.model.refresh.button',
  'section.ai.model.refresh.loading',
  'section.ai.model.refresh.unsupported',
  'section.ai.model.refresh.empty',
  'section.ai.model.refresh.error',
  'section.ai.model.refresh.useHardcoded',
  'section.ai.model.refresh.useRemote',
  'section.ai.model.refresh.fromCache',
  'section.ai.model.refresh.clear',
  'section.ai.model.refresh.justNow',
  'section.ai.model.refresh.minutesAgo',
  'section.ai.model.refresh.atTime',
