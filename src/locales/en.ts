export default {
  ...
  home: {
    ...
    hero: {
      ...
      subtitle2: 'Eight traditional Chinese divination methods · one place.',
      ...
      sealRight: 'tt-qimen',
      sealLeft: 'Bing-Wu',
      eyebrow: 'MVP v1.0 · Eight modules live',
      ...
      subtitleMn2: 'Experience eight Chinese divination methods in your browser.',
    ...
    sectionDivider: '✦ Eight divination methods ✦',
  ...
  ai: {
    ...
    history: {
      ...
      title: 'Chat history',
      viewAria: 'View chat history',
      backToChat: 'Back to current chat',
      backAria: 'Back',
      empty: 'No chat history yet',
      emptyHint: 'Once you start chatting with the AI on any chart, the session is saved locally.',
      currentBadge: 'Current',
      messageCount: '{count} messages',
      deleteAria: 'Delete this session',
      deleteTitle: 'Delete this session?',
      deleteConfirm: 'Delete session "{label}"? This cannot be undone.',
      deleteConfirmBtn: 'Delete',
      clearAll: 'Clear all',
      clearAllTitle: 'Clear all history?',
      clearConfirm: 'This will permanently delete all {count} sessions. Continue?',
      clearAllConfirmBtn: 'Clear all',
      confirmCancel: 'Cancel',
      readonlyBanner: 'You are viewing a saved session. To continue chatting, open the {module} module and recreate the same chart.',
      readonlyInputDisabled: 'Sending is disabled while viewing history',
      relative: {
        justNow: 'just now',
