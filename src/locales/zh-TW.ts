export default {
  ...
  common: {
    ...
    birthInput: {
      ...
      advancedToggle: '進階選項 · 真太陽時',
      advancedToggleClose: '收起進階選項',
      trueSolarLabel: '使用真太陽時',
      trueSolarHint: '依出生地經度修正時柱，更貼近古法。',
      birthplaceLabel: '出生城市',
      birthplacePlaceholder: '選擇城市（可選）',
      birthplaceCustom: '其他 · 手動輸入經度',
      longitudeLabel: '經度',
      longitudePlaceholder: '例如 121.47（°E 為正，°W 為負）',
      longitudeHint: '範圍 -180 ~ 180。台北時間標準子午線 120°E。',
      offsetPreview: '修正：{sign}{minutes} 分鐘',
      offsetPreviewNoChange: '修正：±0 分鐘（與時鐘時間一致）',
      cities: {
