...
export const FLOW_YEAR_HINTS: Record<FlowYearHintKey, FlowYearHint> = {
  ...
  比肩_unfavorable: { hint: '本年防合伙纠纷与口舌，宜独立决断、留足现金流。', tags: ['防合伙纠纷', '现金流'] },
  ...
  // 食神
  食神_favorable: { hint: '本年才艺显发、口福绵长，利文创、教育、餐饮。', tags: ['才艺', '文创'] },
  食神_neutral: { hint: '本年生活平稳，宜在享受过程中持续输出作品。', tags: ['平稳', '输出'] },
  食神_unfavorable: { hint: '本年防过于松弛，宜借兴趣立身，避免懒散。', tags: ['防懒散'] },

  // 伤官
  伤官_favorable: { hint: '本年才华爆发、表达突出，利于艺术、技术、自媒体。', tags: ['创意', '自媒体'] },
  伤官_neutral: { hint: '本年灵感涌现亦需谨言，宜借作品立人设。', tags: ['作品', '谨言'] },
  ...
  // 正官
  正官_favorable: { hint: '本年名分提升、贵人扶持，利体制内升迁与婚配。', tags: ['升迁', '婚配'] },
