export default {
  ...
  common: {
    ...
    birthInput: {
      ...
      birthplaceSearchPlaceholder: '搜尋城市（可選）',
  ...
  home: {
    ...
    hero: {
      ...
      sealRight: '啟門問卜',
      sealLeft: '丙午',
      eyebrow: 'MVP v1.0 · 八模組全面上線',
      titleMnLine1: '一站式',
      titleMnLine2A: '傳統命理',
      titleMnLine2B: '體驗',
      subtitleMn1: '基於開源演算法庫與公版古籍，離線運行、尊重隱私。',
      subtitleMn2: '在瀏覽器中體驗八種中國傳統占卜方術。',
      ctaMnPrimary: '立即排盤',
      ctaMnSecondary: '瀏覽模組',
    },
    stats: {
  ...
  privacyPage: {
    ...
    sections: [
      ...
      },
      {
        heading: '四、第三方資源',
        paragraphs: [
          '本站靜態資源（HTML/JS/CSS/字型/圖示）均自行託管或來自版本固定的開源 CDN。',
          '為了了解訪問量以優化服務，本站載入了 Google Analytics 4 與不蒜子（busuanzi）計數器。這兩個腳本僅採集匹配裝置的匿名訪問量、頁面路徑（不含 URL 中的 query 參數，避免洩漏生辰資料）、粗粒度地區與裝置類型；不寫入第三方追蹤 Cookie，不接觸你輸入的生辰，不整合廣告。這些第三方服務在請求過程中可能短暫看到你的 IP 位址用於 UV 去重與地區識別，本站不持久化、不反向識別你。',
  ...
  ai: {
    ...
    drawer: {
      ...
      firstResponse: '請基於上述命盤資訊，按 system prompt 中的「模組解讀骨架」逐節展開一份**全面、深入**的整體解讀：每節先一句結論、再引用命盤裡的具體欄位作為依據、最後補一句「在日常生活中意味著什麼」；末尾給出 3-5 條可落地的行動建議。',
    },
    history: {
      ...
      backAria: '返回',
      empty: '尚無對話歷史',
      emptyHint: '在任意命盤上開始與 AI 對話後，會話會自動儲存於本機。',
      currentBadge: '當前',
      messageCount: '{count} 條訊息',
      deleteAria: '刪除該會話',
      deleteTitle: '刪除該會話？',
      deleteConfirm: '確定要刪除會話「{label}」嗎？該操作無法撤銷。',
      deleteConfirmBtn: '刪除',
      clearAll: '清空全部',
      clearAllTitle: '清空全部歷史？',
      clearConfirm: '將清除全部 {count} 個會話歷史，無法撤銷。是否繼續？',
      clearAllConfirmBtn: '全部清空',
      confirmCancel: '取消',
      readonlyBanner: '你正在查看歷史會話。如需繼續提問，請回到 {module} 模組重新排出同一命盤。',
      readonlyInputDisabled: '查看歷史會話時無法傳送訊息',
      relative: {
        justNow: '剛剛',
        minutesAgo: '{n} 分鐘前',
        hoursAgo: '{n} 小時前',
