---
title: 穷通宝鉴 · 全文
author: 余春台（清）整理 · 原作历代相传
source: https://zh.wikisource.org/wiki/%E7%AA%AE%E9%80%9A%E5%AF%B6%E9%91%92
fetched_at: 2026-04-20
encoding: 简体（来自维基文库 zh-hans 转写）
license: 公有领域（作者逝世已逾 100 年；维基文库附加 PD-old 声明）
notes: |
  《穷通宝鉴》是中国清代命理经典，以"日干 × 月令"为纲，详述十干在十二月的喜忌、调候用神。
  本模块用于：日主分析（哪个月生命格特点）、调候用神推荐、四时五行喜忌文案生成。
  
  原书结构：
  - 五行总论
  - 论木 / 论甲木 / 论乙木（含三春 / 三夏 / 三秋 / 三冬，每月专论）
  - 论火 / 论丙火 / 论丁火
  - 论土 / 论戊土 / 论己土
  - 论金 / 论庚金 / 论辛金
  - 论水 / 论壬水 / 论癸水
